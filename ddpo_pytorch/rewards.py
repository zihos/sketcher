...
def mplug_tifascore():
    ...
    def _fn(images, prompts, metadata):
        ...
        for image_batch, prompt_batch in zip(images_batched, prompts_batched):
            ...
            # use the tifa score as the reward
            all_scores.append(response_data["outputs"])
        ...
        return np.array(all_scores), np.array(all_scores)
...
def llava_bertscore():
    ...
    def _fn(images, prompts, metadata):
        ...
        for image_batch, prompt_batch in zip(images_batched, prompts_batched):
            ...
            # save the precision and f1 scores for analysis
            all_info["precision"] += (
                [np.array(response_data["precision"]).squeeze()]
            )
